...
void AItem::SetRarityDataTable()
{
	// 데이터테이블 로드(ItemRarity)
	FString RarityTablePath(TEXT("DataTable'/Game/00_MazeDev/DataTable/ItemRarityDataTable.ItemRarityDataTable'"));
